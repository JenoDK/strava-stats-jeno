...
import { REACT_APP_CLIENT_ID, REACT_APP_REDIRECT_BASE_URI, scope } from '../constants/StravaConstants';
...
function DashboardContent(props: DashboardProperties) {
    ...
    const handleStravaLogin = () => {
        window.location.replace(`http://www.strava.com/oauth/authorize?client_id=${REACT_APP_CLIENT_ID}&response_type=code&redirect_uri=${REACT_APP_REDIRECT_BASE_URI}/redirect/exchange_token&approval_prompt=force&scope=${scope}`);
    };
